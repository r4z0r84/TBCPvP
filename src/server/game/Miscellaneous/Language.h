...
enum SkyFireStrings
{
    ...
    LANG_TEMPEVENT_INFO                 = 64,
    LANG_TEMPEVENT_INFO_STATUS          = 65,
    LANG_TEMPEVENT_INFO_LOCATION        = 66,
    LANG_TEMPEVENT_INFO_PLIMIT          = 67,
    LANG_TEMPEVENT_INFO_PCOUNT          = 68,
    LANG_TEMPEVENT_INFO_PARTICIPANTS    = 69,
    LANG_TEMPEVENT_NOT_SET_PLIMIT       = 70,
    LANG_TEMPEVENT_NOT_SET_LOCATION     = 71,
    LANG_TEMPEVENT_ALREADY_ACTIVE       = 72,
