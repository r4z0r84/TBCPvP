...
void Player::EnvironmentalDamage(EnviromentalDamage type, uint32 damage)
{
    ...
    uint32 resist = 0;
    if (type == DAMAGE_LAVA)
        CalcAbsorbResist(this, SPELL_SCHOOL_MASK_FIRE, DIRECT_DAMAGE, damage, &absorb, &resist, false);
    else if (type == DAMAGE_SLIME)
        CalcAbsorbResist(this, SPELL_SCHOOL_MASK_NATURE, DIRECT_DAMAGE, damage, &absorb, &resist, false);
...
void Player::AutoLearnTalentsForLevel()
{
    ...
    case CLASS_DRUID:
        ...
        {
            if (pLevel >= 68)
                learnSpell(27009);          // Rank 7
            else if (pLevel >= 58)
                learnSpell(17329);          // Rank 6
        }
        if (HasSpell(5570))                 // Insect Swarm, rank 1
        {
            if (pLevel == 70)
                learnSpell(27013);          // Rank 6
            else if (pLevel >= 60)
                learnSpell(24977);          // Rank 5
        }
        if (HasSpell(16857))                // Faerie Fire (Feral), rank 1
        {
            if (pLevel >= 66)
                learnSpell(27011);          // Rank 5
            else if (pLevel >= 54)
                learnSpell(17392);          // Rank 4
        }
        if (HasSpell(33878))                // Mangle (Bear), rank 1
        {
            if (pLevel >= 68)
                learnSpell(33987);          // Rank 3
            else if (pLevel >= 58)
                learnSpell(33986);          // Rank 2
        }
        if (HasSpell(33876))                // Mangle (Cat), rank 1
        {
            if (pLevel >= 68)
                learnSpell(33983);          // Rank 3
            else if (pLevel >= 58)
                learnSpell(33982);          // Rank 2
        }
        break;
    case CLASS_ROGUE:
        ...
        {
            if (pLevel == 70)
                learnSpell(26864);          // Hemorrhage, rank 4
            else if (pLevel >= 58)
                learnSpell(17348);          // Hemorrhage, rank 3
        }
        if (HasSpell(1329))                 // Mutilate, rank 1
        {
            if (pLevel == 70)
                learnSpell(34413);          // Mutilate, rank 4
            else if (pLevel >= 60)
                learnSpell(34412);          // Mutilate, rank 3
        }
        break;
    case CLASS_WARRIOR:
        ...
        {
            if (pLevel == 70)
                learnSpell(30356);          // Shield Slam, rank 6
            else if (pLevel >= 66)
                learnSpell(25258);          // Shield Slam, rank 5
            else if (pLevel >= 60)
                learnSpell(23925);          // Shield Slam, rank 4
        }
        if (HasSpell(20243))                // Devastate, rank 1
        {
            if (pLevel == 70)
                learnSpell(30022);          // Devastate, rank 3
            else if (pLevel >= 60)
                learnSpell(30016);          // Devastate, rank 2
        }
        if (HasSpell(23881))                // Bloodthirst, rank 1
        {
            if (pLevel == 70)
                learnSpell(30335);          // Bloodthirst, rank 6
            else if (pLevel >= 66)
                learnSpell(25251);          // Bloodthirst, rank 5
            else if (pLevel >= 60)
                learnSpell(23894);          // Bloodthirst, rank 4
        }
        if (HasSpell(29801))                // Rampage, rank 1
        {
            if (pLevel == 70)
                learnSpell(30033);          // Rampage, rank 3
            else if (pLevel >= 60)
                learnSpell(30030);          // Rampage, rank 2
        }
        if (HasSpell(12294))                // Mortal Strike, rank 1
        {
            if (pLevel == 70)
                learnSpell(30330);          // Mortal Strike, rank 6
            else if (pLevel >= 66)
                learnSpell(25248);          // Mortal Strike, rank 5
            else if (pLevel >= 60)
                learnSpell(21553);          // Mortal Strike, rank 4
        }
        break;
    case CLASS_PRIEST:
        if (HasSpell(14752))                // Divine Spirit, rank 1
        {
            if (pLevel == 70)
            {
                learnSpell(25312);          // Divine Spirit, rank 5
                learnSpell(32999);          // Prayer of Spirit, rank 2
            }
            else if (pLevel >= 60)
            {
                learnSpell(27841);          // Divine Spirit, rank 4
                learnSpell(27681);          // Prayer of Spirit, rank 1
            }
        }
        if (HasSpell(15237))                // Holy Nova, rank 1
        {
            if (pLevel >= 68)
                learnSpell(25331);          // Holy Nova, rank 7
            else if (pLevel >= 60)
                learnSpell(27801);          // Holy Nova, rank 6
        }
        if (HasSpell(724))                  // Lightwell, rank 1
        {
            if (pLevel == 70)
                learnSpell(28275);          // Lightwell, rank 4
            else if (pLevel >= 60)
                learnSpell(27871);          // Lightwell, rank 3
        }
        if (HasSpell(34861))                // Circle of Healing, rank 1
        {
            if (pLevel == 70)
                learnSpell(34866);          // Circle of Healing, rank 5
            else if (pLevel >= 65)
                learnSpell(34865);          // Circle of Healing, rank 4
            else if (pLevel >= 60)
                learnSpell(34864);          // Circle of Healing, rank 3
        }
        if (HasSpell(15407))                // Mind Flay, rank 1
        {
            if (pLevel >= 68)
                learnSpell(25387);          // Mind Flay, rank 7
            else if (pLevel >= 60)
                learnSpell(18807);          // Mind Flay, rank 6
        }
        if (HasSpell(34914))                // Vampiric Touch, rank 1
        {
            if (pLevel == 70)
                learnSpell(34917);          // Vampiric Touch, rank 3
            else if (pLevel >= 60)
                learnSpell(34916);          // Vampiric Touch, rank 2
        }
        break;
    case CLASS_SHAMAN:
        ...
        {
            if (pLevel == 70)
                learnSpell(32594);          // Rank 3
            else if (pLevel >= 60)
                learnSpell(32593);          // Rank 2
        }
        break;
    case CLASS_PALADIN:
        ...
        {
            if (pLevel == 70)
                learnSpell(33072);          // Rank 5
            else if (pLevel >= 64)
                learnSpell(27174);          // Rank 4
            else if (pLevel >= 56)
                learnSpell(20930);          // Rank 3
        }
        if (HasSpell(20911))                // Blessing of Sanctuary, rank 1
        {
            if (pLevel == 70)
            {
                learnSpell(27168);          // Rank 5
                learnSpell(27169);          // Greater Blessing of Sanctuary, rank 2
            }
            else if (pLevel >= 60)
            {
                learnSpell(20914);          // Rank 4
                learnSpell(25899);          // Greater Blessing of Sanctuary, rank 1
            }
        }
        if (HasSpell(20925))                // Holy Shield, rank 1
        {
            if (pLevel == 70)
                learnSpell(27179);          // Rank 4
            else if (pLevel >= 60)
                learnSpell(20928);          // Rank 3
        }
        if (HasSpell(31935))                // Avenger's Shield, rank 1
        {
            if (pLevel == 70)
                learnSpell(32700);          // Rank 3
            else if (pLevel >= 60)
                learnSpell(32699);          // Rank 2
        }
        if (HasSpell(20217))                // Blessing of Kings
        {
            if (pLevel >= 60)
                learnSpell(25898);          // Greater Blessing of Kings
        }
        if (HasSpell(20375))                // Seal of Command, rank 1
        {
            if (pLevel == 70)
                learnSpell(27170);          // Rank 6
            else if (pLevel >= 60)
                learnSpell(20920);          // Rank 5
        }
        break;
    case CLASS_HUNTER:
        ...
        {
            if (pLevel == 70)
                learnSpell(27065);          // Rank 7
            else if (pLevel >= 60)
                learnSpell(20904);          // Rank 6
        }
        if (HasSpell(19506))                // Trueshot Aura, rank 1
        {
            if (pLevel == 70)
                learnSpell(27066);          // Rank 4
            else if (pLevel >= 60)
                learnSpell(20906);          // Rank 3
        }
        if (HasSpell(19306))                // Counterattack, rank 1
        {
            if (pLevel >= 66)
                learnSpell(27067);          // Rank 4
            else if (pLevel >= 54)
                learnSpell(20910);          // Rank 3
        }
        if (HasSpell(19386))                // Wyvern Sting, rank 1
        {
            if (pLevel == 70)
                learnSpell(27068);          // Rank 4
            else if (pLevel >= 60)
                learnSpell(24133);          // Rank 3
        }
        break;
    case CLASS_MAGE:
        ...
        {
            if (pLevel == 70)
                learnSpell(33938);          // Rank 10
            else if (pLevel >= 66)
                learnSpell(27132);          // Rank 9
            else if (pLevel >= 60)
                learnSpell(18809);          // Rank 8
        }
        if (HasSpell(11113))                // Blast Wave, rank 1
        {
            if (pLevel == 70)
                learnSpell(33933);          // Rank 7
            else if (pLevel >= 65)
                learnSpell(27133);          // Rank 6
            else if (pLevel >= 60)
                learnSpell(13021);          // Rank 5
        }
        if (HasSpell(31661))                // Dragon's Breath, rank 1
        {
            if (pLevel == 70)
                learnSpell(33043);          // Rank 4
            else if (pLevel >= 64)
                learnSpell(33042);          // Rank 3
            else if (pLevel >= 54)
                learnSpell(33041);          // Rank 2
        }
        if (HasSpell(11426))                // Ice Barrier, rank 1
        {
            if (pLevel == 70)
                learnSpell(33405);          // Rank 6
            else if (pLevel >= 64)
                learnSpell(27134);          // Rank 5
            else if (pLevel >= 58)
                learnSpell(13033);          // Rank 4
        }
        break;
    case CLASS_WARLOCK:
        ...
        {
            if (pLevel == 70)
                learnSpell(27265);          // Rank 4
            else if (pLevel >= 60)
                learnSpell(18938);          // Rank 3
        }
        if (HasSpell(18265))                // Siphon Life Rank 1
        {
            if (pLevel == 70)
                learnSpell(30911);          // Rank 6
            else if (pLevel >= 63)
        ...
        {
            if (pLevel == 70)
                learnSpell(30405);          // Rank 3
            else if (pLevel >= 60)
                learnSpell(30404);          // Rank 2
        }
        if (HasSpell(17877))                // Shadowburn Rank 1
        {
            if (pLevel == 70)
                learnSpell(30546);          // Rank 8
            else if (pLevel >= 63)
                learnSpell(27263);          // Rank 7
            else if (pLevel >= 56)
                learnSpell(18871);          // Rank 6
        }
        if (HasSpell(17962))                // Conflagrate Rank 1
        {
            if (pLevel == 70)
                learnSpell(30912);          // Rank 6
            else if (pLevel >= 65)
                learnSpell(27266);          // Rank 5
            else if (pLevel >= 60)
                learnSpell(18932);          // Rank 4
        }
        if (HasSpell(30283))                // Shadowfury Rank 1
        {
            if (pLevel == 70)
                learnSpell(30414);          // Rank 3
            else if (pLevel >= 60)
                learnSpell(30413);          // Rank 2
        }
        break;
    }
}
